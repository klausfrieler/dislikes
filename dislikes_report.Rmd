...
However, the correlation matrices of subscales differ significantly between the four main conditions (Jennrich's test for correlation matrices:  *p < .001* for all condition pairs). The distributions are partly also different, but the general observations from above still hold up (see Supplementary Material, Fig. SP1-5).
